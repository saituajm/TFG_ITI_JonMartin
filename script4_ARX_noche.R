...

{
  ...
  dataframe_trabajo <- readRDS("C:/Users/Admin/Desktop/TFG ITI/COD_INIGO/rds_files/dataframe_noche.rds")
...
{
  variables_regresion_input<-c("temperatura_exterior")
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_1.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_2.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_3.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_4.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_5.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_6.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_7.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_resultados_noche_8.csv", sep=""))
