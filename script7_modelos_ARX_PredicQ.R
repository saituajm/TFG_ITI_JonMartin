...

{
  ...
  regresion_output<-"energia_agua_refrigerada"
...

{
  for (j in 0:obs_anteriores){
    ...
    temperatura_interior_med<-
      dataframe_trabajo$energia_agua_refrigerada[x:nrow(dataframe_trabajo)]
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_1.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_2.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_3.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_4.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_5.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_6.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_7.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_predQ_8.csv", sep=""))
