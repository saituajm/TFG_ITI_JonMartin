...

{
  ...
  dataframe_trabajo <- readRDS("C:/Users/Admin/Desktop/TFG ITI/COD_INIGO/rds_files/dataframe_dia.rds")
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_1.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_2.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_3.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_4.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_5.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_6.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_7.csv", sep=""))
...
write.csv2(dataframe_resultados, 
           paste(wd, "/output/dataframe_res_diatodo_8.csv", sep=""))
